    ...
    class Players 
    {
        ...
        public function setGoalsToAchieve()
        {
            try {
                ...
                foreach ($this->rules as $item => $value){
        ...
        public function setTotalSalary($item,$salary,$bonus,$mean){
            $this->data['jugadores'][$item]['sueldo_completo'] = $salary + (($bonus * $mean) / 100);
        }

        public function jsonExport(){

            $generate_json = json_encode ( $this->data );
